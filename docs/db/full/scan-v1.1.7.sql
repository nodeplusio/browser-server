...
CREATE TABLE `token` (
                         ...
                         `is_support_erc1155` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否支持erc1155接口： 0-不支持 1-支持',
                         `is_support_erc1155_metadata` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否支持erc1155 metadata接口： 0-不支持 1-支持',
                         `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                         `update_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP COMMENT '更新时间',
